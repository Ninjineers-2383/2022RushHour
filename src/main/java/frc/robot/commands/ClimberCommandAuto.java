...
public class ClimberCommandAuto extends CommandBase {
    ...
    public ClimberCommandAuto(ClimberSubsystemNew subsystem, DoubleSupplier climbPower, double finalPosition) {
